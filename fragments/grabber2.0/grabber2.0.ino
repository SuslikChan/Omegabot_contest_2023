...
int openAng = 50;       // Угол захвата
int closeAng = 180;     // Угол отпуска
int grabDelay = 100;    // Время замедления

ServoSmooth servos[AMOUNT];
uint32_t servoTimer;
uint32_t turnTimer;
int position1 = 15;   // первое положение сервы 1 (вверх-вниз)
